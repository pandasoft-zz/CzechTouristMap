...
<rule cat="contours" e="way" k="contour_ext" v="*">
  ...
  <rule e="way" k="contour_ext" v="elevation_major" zoom-min="10" zoom-max="12">
    <line stroke="#D9A840" stroke-width="0.45" stroke-linecap="butt" scale="none"/>
  </rule>
  <rule e="way" k="contour_ext" v="elevation_major" zoom-min="13">
    <line stroke="#D9A840" stroke-width="0.7" stroke-linecap="butt" scale="none"/>
  </rule>
  <!-- Medium contours — mid brown -->
  <rule e="way" k="contour_ext" v="elevation_medium" zoom-min="11" zoom-max="12">
    <line stroke="#E2B860" stroke-width="0.3" stroke-linecap="butt" scale="none"/>
  </rule>
  <rule e="way" k="contour_ext" v="elevation_medium" zoom-min="13">
    <line stroke="#E2B860" stroke-width="0.5" stroke-linecap="butt" scale="none"/>
  </rule>
  <!-- Minor/auxiliary contours — light warm brown, semi-transparent -->
  <rule e="way" k="contour_ext" v="elevation_minor" zoom-min="14">
    <line stroke="#80D4A040" stroke-width="0.3" stroke-linecap="butt" scale="none"/>
  </rule>
  ...
  <rule e="way" k="contour_ext" v="elevation_major" zoom-min="13" zoom-max="15">
    <pathText k="ele" font-size="8" font-style="italic" fill="#868d7a" stroke="#FFFFFF" stroke-width="1" repeat="true" repeat-gap="250" priority="{$pr-label-contour-ele}"/>
  </rule>
  <rule e="way" k="contour_ext" v="elevation_major|elevation_medium" zoom-min="16" zoom-max="16">
    <pathText k="ele" font-size="9" font-style="italic" fill="#868d7a" stroke="#FFFFFF" stroke-width="1" repeat="true" repeat-gap="250" priority="{$pr-label-contour-ele}"/>
  </rule>
  <rule e="way" k="contour_ext" v="elevation_major|elevation_medium" zoom-min="17">
    <pathText k="ele" font-size="10" font-style="italic" fill="#868d7a" stroke="#FFFFFF" stroke-width="1" repeat="true" repeat-gap="300" priority="{$pr-label-contour-ele}"/>
  </rule>
</rule>
